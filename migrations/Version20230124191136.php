 ...
 */
final class Version20230124191136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tax (id INT NOT NULL, country VARCHAR(255) NOT NULL, prefix VARCHAR(10) NOT NULL, taxation NUMERIC(5, 4) NOT NULL, PRIMARY KEY(id))');
